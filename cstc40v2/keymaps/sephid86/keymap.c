...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * ├───┼───┼───┼───┼───┼───┴───┼───┼───┼───┼───┼───┤
     * │Ctl│Alt│GUI│NUM│FNC│  Spc  │   │NAV│Alt│App│Ctl│
     * └───┴───┴───┴───┴───┴───────┴───┴───┴───┴───┴───┘
     */
    [_BASE] = LAYOUT_planck_mit(
        // KC_ESC,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,    KC_Y,     KC_U,     KC_I,     KC_O,    KC_P,     KC_BSPC,
        QK_GESC,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,    KC_Y,     KC_U,     KC_I,     KC_O,    KC_P,     DF(_NUMLCK),
        KC_TAB,   KC_A,     KC_S,     KC_D,     KC_F,     KC_G,    KC_H,     KC_J,     KC_K,     KC_L,    KC_SCLN,  KC_ENT,
        KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,    KC_N,     KC_M,     KC_COMM,  KC_DOT,  KC_SLSH,  KC_RSFT,
        KC_LCTL,  KC_LALT,  KC_LGUI,  MO(_NUMLCK),  MO(_FUNC),  KC_SPC,  _______,  MO(_NAVI),  KC_RALT,  KC_APP,   KC_RCTL
    ),
     ...
     * │ ` │ ! │ @ │ # │ $ │ % │ ^ │ & │ * │ ( │ ) │Bsp│
     * ├───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┤
     * │Cap│   │Prt│   │   │   │Vup│Dn │Hom│Pup│Quo│TRN│
     * ├───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┤
     * │TRN│   │   │   │   │   │Vdn│Eql│End│Pdn│Up │TRN│
     * ├───┼───┼───┼───┼───┼───┴───┼───┼───┼───┼───┼───┤
    ...
    [_NAVI] = LAYOUT_planck_mit(
        ...
        KC_CAPS,  _______,  KC_PSCR,  _______,  _______,  _______,  _______,  KC_VOLU,  KC_HOME,  KC_PGUP, KC_QUOTE,  KC_TRNS,
        KC_TRNS,  _______,  _______,  _______,  _______,  _______,  _______,  KC_VOLD,   KC_END,  KC_PGDN,    KC_UP,  KC_TRNS,
...
// const key_override_t tilde_key_override = ko_make_basic(MOD_MASK_SHIFT, KC_ESC, KC_TILD);
